...
ARG MINIO_VERSION="RELEASE.2024-09-22T00-33-43Z"
...
COPY /download-static-curl.sh /build/download-static-curl
RUN chmod +x /build/download-static-curl && /build/download-static-curl
